      ...
      <div className="space-y-8">
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-1">
            <h1 className="text-4xl font-black uppercase tracking-tighter">Add <span className="text-primary">Product</span></h1>
            <p className="text-muted-foreground font-medium italic">Create a new item in your catalog.</p>
          </div>
        </div>
